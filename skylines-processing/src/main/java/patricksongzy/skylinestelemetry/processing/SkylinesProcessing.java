...
//        System.out.println(cur.im);
        ...
        DataStream<Complex[]> populationFrequencyDomain = populationStream.windowAll(SlidingEventTimeWindows.of(Time.days(3650), Time.days(365))).apply(new FourierWindowFunction());
